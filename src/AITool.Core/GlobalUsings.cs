...
global using ProxyProtocolBridge = AITool.Protocol.ProxyProtocolBridge;
global using ChatToResponsesStreamState = AITool.Protocol.ChatToResponsesStreamState;
...
// 模型并发控制相关类型，原先是 Core/Services 下的副本，现已统一到 Infrastructure/Proxy 层。
...
// 开发者调用追踪相关类型，原先是 Core/Services 下的副本，现已统一到 Infrastructure/Proxy 层。
