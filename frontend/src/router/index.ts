...
const routes: RouteRecordRaw[] = [
  { path: '/login', name: 'login', component: () => import('@/views/LoginView.vue'), meta: { public: true, title: '登录' } },
  {
    ...
    children: [
      ...
      { path: 'routes', name: 'routes', component: () => import('@/views/PlaceholderView.vue'), meta: { title: '路由规则' } },
      { path: 'access-keys', name: 'access-keys', component: () => import('@/views/PlaceholderView.vue'), meta: { title: '访问密钥' } },
      ...
      { path: 'usage-logs', name: 'usage-logs', component: () => import('@/views/PlaceholderView.vue'), meta: { title: '使用日志' } },
      { path: 'analytics', name: 'analytics', component: () => import('@/views/PlaceholderView.vue'), meta: { title: '统计分析' } },
      { path: 'compatibility', name: 'compatibility', component: () => import('@/views/PlaceholderView.vue'), meta: { title: '兼容规则' } },
