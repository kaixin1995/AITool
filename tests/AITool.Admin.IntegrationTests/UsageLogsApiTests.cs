...
namespace AITool.Admin.IntegrationTests.UsageLogs;
...
/// </summary>
internal sealed class UsageLogsWebApplicationFactory : WebApplicationFactory<AITool.Admin.AdminProgramMarker>
{
    /// <summary>
    /// 带有两次尝试记录的请求标识。
    /// </summary>
